/* License: MIT */
finalSlideImages = [];
function sendSlideShowImages(imagescomma) {
	imagesArray = imagescomma.split(',')
	imagesArray.forEach(element => {
		finalSlideImages.push({src: element,position: 'center',motion: 'none',speed: 2,caption: 'na',})
	});
}
